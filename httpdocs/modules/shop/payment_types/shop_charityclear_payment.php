...
class Shop_Charityclear_Payment extends Shop_PaymentType
{
    public function get_info()
    {
        return array(
            'name' => 'CharityClear Integration',
    ...
    {
        return array(
            'ls_charityclear_notification' => 'process_payment_notification'
        );
    }
    ...
    public function get_hidden_fields($host_obj, $order, $backend = false)
    {
        ...
        $fields['redirectURL'] = root_url('/ls_charityclear_notification/' . $order->id . '?utm_nooverride=1&nocache' . uniqid(), true);
    ...
    {
        return "https://gateway.charityclear.com/hosted/";
    }
    ...
    public function process_payment_notification($params)
    {
        ...
        try {
            ...
            if (!($payment_method_obj instanceof Shop_Charityclear_Payment))
